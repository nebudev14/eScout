/*
  ...
  - You are about to drop the column `questionId` on the `MatchFormResponse` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "MatchFormResponse" DROP CONSTRAINT "MatchFormResponse_questionId_fkey";
...
-- AlterTable
ALTER TABLE "MatchFormResponse" DROP COLUMN "questionId";
